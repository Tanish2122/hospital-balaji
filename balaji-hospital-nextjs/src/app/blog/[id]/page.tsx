...
const BlogDetailPage = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  // Formatting date
  const dateObj = postData.published_at ? new Date(postData.published_at) : new Date(postData.created_at);
  ...
  const post = {
    ...
    image: postData.featured_image_url || '/images/gallery/building.png',
      ...
      <section className="py-16">
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative aspect-[21/9] rounded-[3rem] overflow-hidden mb-16 shadow-2xl bg-slate-100">
              <Image
                src={post.image}
                alt={post.title}
                fill
