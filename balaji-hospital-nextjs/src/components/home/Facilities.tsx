...
export default function Facilities() {
  return (
    <section id="facilities" className="py-24 pb-20 relative overflow-hidden bg-white">
      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          {/* Stats badge — placed in flow so overflow:hidden doesn't clip it */}
          <motion.div
          ...
          >
            <div className="glass px-8 py-6 rounded-[2rem] border border-white/20 shadow-2xl flex items-center gap-8">
              <div className="text-center">
                <span className="block text-3xl font-black text-medical-600">24/7</span>
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1">Emergency</span>
              </div>
              <div className="h-10 w-px bg-slate-200" />
              <div className="text-center">
                <span className="block text-3xl font-black text-emerald-600">100+</span>
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1">Beds</span>
              </div>
              <div className="h-10 w-px bg-slate-200" />
              <div className="text-center">
                <span className="block text-3xl font-black text-amber-600">28+</span>
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1">Years</span>
              </div>
            </div>
          </motion.div>
        </div>
